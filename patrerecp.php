...
{
echo '<script>alert(" Please Enter Number Only  ")</script>'; 
}
else
{
$m=$_POST['t4'];
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarExample01"> <a class="btn btn-outline-light  ml-5 mr-5" href="patupdate.php" role="button">Update Patient</a>
...
<br>
<div class="container">
    <select class="form-control" name="bg" style="width: 388px; font-size: 0.95em;" >
