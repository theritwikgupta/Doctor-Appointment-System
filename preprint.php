...
</svg>    Print Prescription <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg> </b></h2>
...
$q="select distinct(username) from presc where dname='$_SESSION[fname]' ";
$result=mysqli_query($conn,$q);
?>
<div class="login-container">
<p style="margin-left:00px; width:479px;"  ><select class="form-control" id="username"  name="username"></p>
...
$q="select * from presc  where username='$_POST[username]'   and date='$_POST[date]' ";
...
<div class="login">
 <h2 class="login-header">  <b><svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <form  action="form.php" method="post"   class="login-container"> <br> 	
...
<label  style="margin-left:100px;" for="dname">Doctor First Name</label>
   <input style="margin-left:100px;"  type="text" name="dname" id="dname"  placeholder="Enter First Number" value="<?php echo $row['dname']?>" >
   
<label  style="margin-left:100px;" for="doclname">Doctor Last Name</label>
   <input style="margin-left:100px;"  type="text" name="doclname" id="doclname"  placeholder="Enter Last Number" value="<?php echo $row['dlname']?>" >
   
<label  style="margin-left:100px;" for="prec">Add Precreption</label>
<textarea  style="width:475px; margin-left:100px;" class="form-control" id="psc"  name="psc"    rows="2" ><?php  echo $row['presc']  ?></textarea>     <br>   
<textarea style="width:475px; margin-left:100px;" class="form-control" id="prsc1"  name="prsc1"  rows="2" ><?php  echo $row['prsc1']  ?></textarea>     <br>  
 
<input  style="margin-left:100px;"type="submit" value="Print Precereption Here" name="Print"><br>
    </form>
