  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
             ...
             <a class="btn btn-outline-light  ml-3 mr-3" href="patmyde.php" role="button">My Details</a>
			   <a class="btn btn-outline-light  ml-3 mr-3" href="demosearch.php" role="button">Book Appointment</a>
			     <a class="btn btn-outline-light  ml-3 mr-3" href="viewapp.php" role="button">View  Booking</a>
				
				    <a class="btn btn-outline-light  ml-3 mr-3" href="cancelapp.php" role="button">cancel Booking</a>
		 <a class="btn btn-outline-light  ml-3 mr-3" href="feedback.php" role="button">Give Feedback</a>
 <a class="btn btn-outline-light  ml-3 mr-3" href="previwe.php" role="button">Prescription History</a>
  ...
  <path fill-rule="evenodd" d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/>
            ...
            <li><a class="dropdown-item" href="patchange.php">change Password</a></li>
...
<?php
   ...
   $a=$_SESSION['username'];
   $sql = "SELECT fname,lname,mno FROM regp where username=' ".$a. " ' ";
...
$_SESSION['mno']=$row["mno"];
 ...
 <div id="body" style="margin-left:595px;" >
   
   <img src="images/pat.jpg" alt="" width="300" height="300">
</div>
