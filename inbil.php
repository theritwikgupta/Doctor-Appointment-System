...
<center>
 ...
 <p><input type="text" placeholder="Enter Date" name="date"  value="<?php echo date("d/m/Y") ?>" required ></p>
...
$q="select * from billpay where username=' ".$username." ' and date='$_POST[date]' ";
...
<div class="login">
 <h2 class="login-header">  <b>Patient Details</b></h2>
  ...
  <form  action=" inbill.php" method="post"   class="login-container"> 
  
<label  style="margin-left:100px;" for="bill">Bill Number</label>
  <input style="margin-left:100px;"type="text" name="bill" id="bill"    value="<?php echo $row['billno'] ?>" ><br>
  
  <input style="margin-left:100px;"  type="hidden" name="username"  value="<?php echo $row['username'] ?>" >
  
 <input style="margin-left:100px;" type="text" name="date" id="date"   value="<?php echo $row['date'] ?>" ><br>
 
<input style="margin-left:100px;" type="text" name="day" id="day"   value="<?php echo $row['day'] ?>" >

<label  style="margin-left:100px;"for="fname">First Name</label>
  <input style="margin-left:100px;" type="text" name="fname" id="fname"   value="<?php echo $row['fname'] ?>" >
  
<label style="margin-left:100px;" for="lname">Last Name</label>
  <input  style="margin-left:100px;"type="text" name="lname" id="lname"   value="<?php echo $row['lname'] ?>" >
  
<label  style="margin-left:100px;"for="age">Age</label>
   <input  style="margin-left:100px;"type="text" name="age" id="age"   value="<?php echo $row['age'] ?>" >
   
 <label  style="margin-left:100px;"for="gender">Gender</label>
   <input  style="margin-left:100px;"type="text" name="gender" id="gender"   value="<?php echo $row['gender'] ?>" >
   
<label  style="margin-left:100px;"for="mno">Mobile Number</label>
<input style="margin-left:100px;" type="text" name="mno"  id="mno"   value="<?php echo $row['mno'] ?>" >

<label style="margin-left:100px;" for="amt">Amount</label>
<input  style="margin-left:100px;"type="text" name="amt"  id="amt"   value="<?php echo $row['amt'] ?>" ><br>

 

<center>
<input type="submit" value="Generate Bill" name="update"><br>
    </form>
</div>
<?php
}
