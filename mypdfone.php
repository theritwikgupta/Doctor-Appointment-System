...
$pdf->Cell(276,10,'PATIENT LIST',0,0,'C');
$pdf->Ln(9);
...
$pdf->Cell(14,10,'Age',1,0,'C');
$pdf->Cell(30,10,'Gender',1,0,'C');
$pdf->Cell(35,10,'Blood Group',1,0,'C');
$pdf->Cell(35,10,'Mobile Number',1,0,'C');
$pdf->Cell(67,10,'Email ID',1,0,'C');
$pdf->Ln();
