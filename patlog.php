...
<br><br>
<div class="login">
 <h2 class="login-header">  <b>Patient Login</b></h2>
...
<center>
  <form  action="patlog.php" method="post"   class="login-container" >
   ...
   <input type="submit" value="Login" name="submit" style="width:515px;">

<center><a href="forgetpass.php">Forgot Password Here</a> </center><br>

<center>New Member <a href="petre.php">Register Here..... </a> </center><br>
