...
<br><br>
<div class="login">
 <h2 class="login-header">  <b>Feedback Us</b></h2>


  <form  action=" " method="post"   class="login-container">

    <p><input type="hidden" id="date"  name="date"  value="<?php echo date("d/m/Y") ?>" required readonly ></p>
<p style="margin-left:120px;">Enter Feedback <input type="text" id="feedback"  name="feedback"   required  ></p>
	  <p><input type="hidden" id="fname"  name="fname"  value="<?php echo $_SESSION['fname'] ?>" required readonly ></p>
<p style="margin-left:120px;"><input type="submit" value="submit" name="submit"></p>
	<p><input type="hidden" id="lname"  name="lname" value="<?php echo $_SESSION['lname'] ?>" required readonly ></p>
     
  
    <p><input type="hidden" id="username"  name="username" value=" <?php echo $_SESSION['username'] ?>" required readonly ></p>
...
{
$sql = "SELECT * FROM feedback WHERE date='$_POST[date]'  and  username='$_SESSION[username]' ";
$res= mysqli_query($cono, $sql);
if (mysqli_num_rows($res) > 0) 
{
  echo "<script>alert(' YOU CAN GIVE  ONLY ONE FEEDBACK  IN DAY   ')</script>";	  	
} 	
else
{
...
$fname=$_POST['fname'];
//$lname='$_POST['lname'];
$del="insert into feedback values('$_POST[date]' ,'$_SESSION[fname]' , '$_SESSION[lname]' , '$_SESSION[username]' ,'$_POST[feedback]') ";
...
{
echo "<script>alert('YOUR FEEDBACK NOT SUBMITED')</script>";
}
}
}
?>
