  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
			   ...
			   <a class="btn btn-outline-light  ml-3 mr-3" href="demodocview.php" role="button">My Appointment</a>
			
				   <a class="btn btn-outline-light  ml-3 mr-3" href="addprecone.php" role="button">Give Prescription</a>
  <a class="btn btn-outline-light  ml-3 mr-3" href="addprecup.php" role="button">Update Prescription</a>
<a class="btn btn-outline-light  ml-3 mr-3" href="preprint.php" role="button">Print Prescription</a>
...
$_SESSION['lname']=$row["lname"];
   ...
   <img src="images/dr.jpg" alt="" width="300" height="300">
</div> 
<br><br><br><br>
