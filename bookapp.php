  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarExample01">
             ...
             <a class="btn btn-outline-light  ml-5 mr-5" href="setapp.php" role="button"> <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-arrow-left-circle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="login">
 <h2 class="login-header">  <b> <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg>  Search & Book Appointment  <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-clipboard-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <form  action=" " method="post"   class="login-container">
    ...
    <p style="padding-left:109px; width:775px; ">Select Date to View My Appointment<input type="text" id="txtdate"  name="txtdate" required readonly ></p>
   <center><p><input type="submit" value="Search" name="Search"></center> <br>
</div>
  </form> <br> <br>
...
<div class="login">
 <h2 class="login-header">  <b><svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
  <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
</svg>  See Session and Book Appointment  <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-clipboard-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/>
  <path fill-rule="evenodd" d="M9.5 1h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3zM8 7a.5.5 0 0 1 .5.5V9H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V10H6a.5.5 0 0 1 0-1h1.5V7.5A.5.5 0 0 1 8 7z"/>
</svg></b></h2>
...
<p style="margin-left:100px; width:670px;" >Enter First Name <input type="text" id="fname"  name="fname" required ></p>
<p style="margin-left:100px; width:670px;">Enter Last Name<input type="text" id="lname"  name="lname" required ></p>
<p style="margin-left:100px;width:670px;">Enter Username <input type="text" id="lname"  name="username1" required ></p>

<p style="margin-left:100px;width:670px;"> Date<input type="text" name="setdate"  id="setdate" placeholder="Enter First Name" value="<?php echo $row['setdate']?>" readonly></p>

 <p style="margin-left:100px; width:670px;"> Session Time <input type="text" name="sess" id="sess"  placeholder="Enter First Name" value="<?php echo $row['sess']?>" readonly></p>

 <p style="margin-left:100px; width:670px;">Doctor<input type="text" name="doc" id="doc"  value="<?php echo $row['doc']?>" readonly></p>

<p style="margin-left:100px; width:670px;">Token ID <input type="text" name="pid" id="pid" value="<?php echo $empid ?>"  readonly></p>

<p style="margin-left:100px; width:670px;"><input type="submit" name="Book" value="Book"></p>
...
$sql_u = "SELECT * FROM bookapp WHERE username='$_POST[username1]' AND setdate='$_POST[setdate]' ";
...
{
$rr="INSERT INTO `bookapp`  (fname,lname,username,setid,setdate,doc,sess,pid) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[username1]','$_POST[setid]','$_POST[setdate]','$_POST[doc]','$_POST[sess]','$_POST[pid]')";
...
$mail->addAddress($_POST['username1']);     
             // Name is optional
...
$a="<h2>Patient Appointment Details</H2><br>First  Name:".$_POST['fname']."<br/>". "Last Name:".$_POST['lname']."<br/>". "Date (mm/dd/yyyy):".$_POST['setdate']."<br/>". "Doctor :".$_POST['doc']."<br/>". "Session TimeSlot :".$_POST['sess']."<br>"."Token ID:".$_POST['pid']."<br>". "<br><h2>Thank You And Take Care</h2>";
$mail->Body    = $a;
//$mail->Body  =;
