...
</svg>    Update Prescription <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456l-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
</svg> </b></h2>
...
<center>
 ...
 <p><input type="text" placeholder="Enter Date" name="date" required ></p>
...
$date=$_POST['date'];
$q="select * from presc  where username=' ".$username." '  and  date='$_POST[date]' ";
...
<center>
 ...
 <input type="text" name="rid" placeholder="Enter username" value="<?php echo $row['rid'] ?>" >
...
<label for="dname">Doctor First Name</label>
   <input type="text" name="dname" id="dname"  placeholder="Enter First Number" value="<?php echo $row['dname']?>" >
   
<label for="doclname">Doctor Last Name</label>
   <input type="text" name="doclname" id="doclname"  placeholder="Enter Last Number" value="<?php echo $row['dlname']?>" >
   
<label for="prec">Add Precreption</label>
<textarea class="form-control" id="psc"  name="psc"    rows="2" ><?php  echo $row['presc']  ?></textarea>     <br>   
<textarea class="form-control" id="psc1"  name="psc1"    rows="2" ><?php  echo $row['prsc1']  ?></textarea>     <br>   
<input type="submit" value="Update Precereption Here" name="update"><br>
    </form>
	</center>
</div>
<?php
...
$sql="update presc set presc='".$presc." '   prsc1='".$psc1."'  where username='".$username."'  " ;
...
$a="<h2>Patient Prescription  Details</H2><br>Patient ID :".$_POST['rid']."<br/>"."First  Name :".$_POST['fname']."<br/>". "Last Name :".$_POST['lname']."<br/>". "Age :".$_POST['age']."<br/>". "Date :".$_POST['date']."<br/>". "Doctor Name :Dr.".$_POST['dname']."<br>"."Prescription :".$_POST['psc']."<br><h2>Thank You And Take Care</h2>";
$mail->Body    = $a;
//$mail->Body  =;
//$mail->AltBody = $_POST['age'];

if(!$mail->send()) {
      echo "<script>alert('Your Registration Data Will be Sent on Email')</script>";
